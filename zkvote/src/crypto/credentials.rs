...
impl<S: AttrScalars> KeyPair<S> {
    ...
    fn credential_core(
        ...
        let u = sho.get_scalar();
        // let U = sho.get_point();
        let sys = SystemParams::get_hardcoded();
        let U = u * sys.G_u;
